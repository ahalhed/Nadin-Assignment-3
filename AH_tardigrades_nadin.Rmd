...
```{r, Nadin 2, message=FALSE, warning=FALSE}
...
From what countries has the phylum Tardigrada been DNA barcoded, based on the data available from BOLD? Which countries have the most data about the phylum Tardigrada?
```{r, Nadin 3}
...
```{r, Alicia 3}
# Repeating code for Nadin 3 chunk with the filtered data
...
Tardigrada_filtered %>%
  ...
  arrange(desc(n)) %>%
  print()
# similar results to Nadin 3 chunk

# Alicia filtered out missing country information here instead of in the figure in like in Nadin 4 chunk
...
#we need to replace all the NAs where specific country don't have a BIN with a zero
...
#### Alicia's Minor Edits
* Some spelling/grammar corrections in the comments
* Coversion to an RMardown file and code formmatting